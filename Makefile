...
ext2cat: ext2_access mmapfs ext2cat.c
	${CC} ${CCOPTS} -o ext2cat ext2cat.c ${OBJDIR}/mmapfs.o ${OBJDIR}/ext2_access.o reference.o
...
ext2cat_ref: ext2_access_ref mmapfs ext2cat.c
	${CC} ${CCOPTS} -o ext2cat_ref ext2cat.c ${OBJDIR}/mmapfs.o ${OBJDIR}/ext2_access_ref.o reference.o
...
ext2_access: objdir reference.o ${LIBDIR}/ext2_access.c
	${CC} ${CCOPTS} -c -o ${OBJDIR}/ext2_access.o ${LIBDIR}/ext2_access.c

ext2_access_ref: objdir reference.o ${LIBDIR}/ext2_access_ref.c
	${CC} ${CCOPTS} -c -o ${OBJDIR}/ext2_access_ref.o ${LIBDIR}/ext2_access_ref.c

reference_implementation: reflib/reference_implementation.c
	${CC} ${CCOPTS} -c -o reference.o reflib/reference_implementation.c
